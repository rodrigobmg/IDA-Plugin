...
#elif DEBUGGER_ID == DEBUGGER_ID_GDB_USER || DEBUGGER_ID == DEBUGGER_ID_ARM_IPHONE_USER
...
//--------------------------------------------------------------------------
static drc_t idaapi init_debugger(
        const char *hostname,
        int port_num,
        const char *password,
        qstring *errbuf)
...
static ssize_t idaapi idd_notify(void *, int msgid, va_list va)
{
  ...
  switch ( msgid )
  {
    ...
    case debugger_t::ev_request_pause:
      errbuf = va_arg(va, qstring *);
      retcode = s_prepare_to_pause_process(errbuf);
      break;

    case debugger_t::ev_exit_process:
      errbuf = va_arg(va, qstring *);
      retcode = s_exit_process(errbuf);
      break;
    ...
    case debugger_t::ev_get_debug_event:
      {
        ...
        *code = s_get_debug_event(event, timeout_ms);
        retcode = DRC_OK;
      }
      break;
    ...
    case debugger_t::ev_resume:
      {
        debug_event_t *event = va_arg(va, debug_event_t *);
        retcode = s_continue_after_event(event);
      }
      break;
    ...
    case debugger_t::ev_thread_get_sreg_base:
      {
        ...
        errbuf = va_arg(va, qstring *);
        retcode = s_thread_get_sreg_base(answer, tid, sreg_value, errbuf);
      }
      break;
    ...
    case debugger_t::ev_get_memory_info:
      {
        ...
        errbuf = va_arg(va, qstring *);
        retcode = s_get_memory_info(*ranges, errbuf);
      }
      break;
    ...
    case debugger_t::ev_read_memory:
      {
        ...
        errbuf = va_arg(va, qstring *);
        ssize_t code = s_read_memory(ea, buffer, size, errbuf);
    ...
    case debugger_t::ev_write_memory:
      {
        ...
        size_t size = va_arg(va, size_t);
        errbuf = va_arg(va, qstring *);
        ssize_t code = s_write_memory(ea, buffer, size, errbuf);
        *nbytes = code >= 0 ? code : 0;
        retcode = code >= 0 ? DRC_OK : DRC_NOPROC;
      }
      break;
    ...
    case debugger_t::ev_update_lowcnds:
      {
        ...
        errbuf = va_arg(va, qstring *);
        retcode = s_update_lowcnds(nupdated, lowcnds, nlowcnds, errbuf);
      }
      break;
    ...
    case debugger_t::ev_open_file:
      {
        ...
        retcode = s_open_file(file, fsize, readonly);
      }
      break;
    ...
    case debugger_t::ev_read_file:
      {
        ...
        size_t size = va_arg(va, size_t);
        retcode = s_read_file(fn, off, buf, size);
      }
      break;
    ...
    case debugger_t::ev_write_file:
      {
        ...
        size_t size = va_arg(va, size_t);
        retcode = s_write_file(fn, off, buf, size);
      }
      break;
    ...
    case debugger_t::ev_map_address:
      {
        ...
        *mapped = s_map_address(ea, regs, regnum);
        return DRC_OK;
      }
      break;
    ...
    case debugger_t::ev_update_call_stack:
      {
        ...
        retcode = s_update_call_stack(tid, trace);
      }
      break;
    #endif
    ...
    case debugger_t::ev_appcall:
      {
        ...
        *blob_ea = s_appcall(func_ea, tid, fti, nargs, regargs, stkargs, retregs, errbuf, event, opts);
        retcode = DRC_OK;
      }
      break;
    ...
    case debugger_t::ev_eval_lowcnd:
      {
        ...
        ea_t ea = va_arg(va, ea_t);
        errbuf = va_arg(va, qstring *);
        retcode = s_eval_lowcnd(tid, ea, errbuf);
      }
      break;
    ...
    case debugger_t::ev_send_ioctl:
      {
        ...
        retcode = s_ioctl(fn, buf, size, poutbuf, poutsize);
      }
      break;
    ...
    case debugger_t::ev_dbg_enable_trace:
      {
        ...
        retcode = s_enable_trace(tid, enable, trace_flags) ? DRC_OK : DRC_NONE;
      }
      break;
    ...
    case debugger_t::ev_is_tracing_enabled:
      {
        ...
        retcode = s_is_tracing_enabled(tid, tracebit) ? DRC_OK : DRC_NONE;
      }
      break;
    ...
    case debugger_t::ev_get_srcinfo_path:
      {
        ...
        bool ok = s_get_srcinfo_path(path, base);
    ...
    case debugger_t::ev_bin_search:
      {
        ...
        errbuf = va_arg(va, qstring *);
        if ( ptns != NULL )
          retcode = s_bin_search(ea, start_ea, end_ea, *ptns, srch_flags, errbuf);
      }
  }
