...
inline bool idaapi enable_step_trace(int enable = true) { return callui(ui_dbg_enable_step_trace, enable).cnd; }
inline bool disable_step_trace(void) { return enable_step_trace(false); }
inline bool idaapi request_enable_step_trace(int enable = true) { return callui(ui_dbg_request_enable_step_trace, enable).cnd; }
...
inline bool idaapi get_current_source_file(qstring *path)                                     { return callui(ui_dbg_get_current_source_file, path).cnd; }
