...
protected:
  ...
  // bh default
  virtual bool jpi_condjump();
  // cmp ncases, rA
  virtual bool jpi_cmp_ncases();
};
...
public:
  ...
  virtual bool jpi2(void) { return jpi_sub_lowcase(); }
  virtual bool jpi1(void) { return jpi_cmp_ncases_condjump(); }
  virtual bool jpi0(void) { return jpi_jump(); }
};
...
public:
  ...
  virtual bool jpi3(void) { return jpi_sub_lowcase(); }
  virtual bool jpi2(void) { return jpi_cmp_ncases_condjump(); }
  virtual bool jpi1(void); // shl shift, rA
  virtual bool jpi0(void); // jmp jumps[rA]
};
...
//----------------------------------------------------------------------
static int is_jump_pattern3(switch_info_t *si, const insn_t &insn)
{
