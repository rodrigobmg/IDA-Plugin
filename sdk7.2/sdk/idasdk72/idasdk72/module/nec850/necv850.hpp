...
extern int ptype; // see proctype_t
extern ea_t g_gp_ea;
extern ea_t g_ctbp_ea;

bool static inline idaapi is_v850e() { return ptype >= (int)V850E; }
bool static inline idaapi is_v850es() { return ptype >= (int)V850ES; }
bool static inline idaapi is_v850e1() { return is_v850es(); }
bool static inline idaapi is_v850e1f() { return is_v850e1(); }
bool static inline idaapi is_v850e2m() { return ptype >= (int)V850E2M; }
bool static inline idaapi is_v850e2() { return is_v850e2m(); }
bool static inline idaapi is_rh850() { return ptype >= (int)RH850; }
